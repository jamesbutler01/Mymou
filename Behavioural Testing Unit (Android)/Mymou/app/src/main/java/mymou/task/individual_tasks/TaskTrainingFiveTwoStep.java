...
public class TaskTrainingFiveTwoStep extends Task {
    ...
    private static ImageButton c1_1, c1_2, c2_1, c2_2;
    ...
    private void assignObjects() {
        ...
        // Create go_cue
        go_cue = UtilsTask.addColorCue(0, prefManager.t_one_screen_colour,
                getContext(), buttonClickListener, getView().findViewById(R.id.parent_task_empty));

        // Create choice 1 and choice 2 cues
//        UtilsTask.addImageCue()

        // Put go_cue in random location
    ...
    private View.OnClickListener buttonClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            // Re-enable go_cue after specified delay
