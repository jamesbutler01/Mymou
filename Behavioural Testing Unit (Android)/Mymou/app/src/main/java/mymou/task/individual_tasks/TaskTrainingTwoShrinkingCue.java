...
public class TaskTrainingTwoShrinkingCue extends Task {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_task_training_two_shrinking_cue, container, false);
    }
    ...
    private void assignObjects() {
        ...
        cue = UtilsTask.addColorCue(0, prefManager.t_one_screen_colour,
                getContext(), buttonClickListener, getView().findViewById(R.id.parent_t_two));
    ...
    private void loadTrialParams() {
        ...
        boolean prev_trial_correct = settings.getBoolean("t_two_successful_trial", false);
        num_consecutive_corr = settings.getInt("t_two_num_consecutive_corr", 0);
    ...
    private void log_trial_outcome(boolean outcome) {
        ...
        editor.putBoolean("t_two_successful_trial", outcome);
        editor.putInt("t_two_num_consecutive_corr", num_consecutive_corr);
        editor.commit();
    }
